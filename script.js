...
function generatePassword() {
  ...
  //Keep looping the prompt if less than 8 or more than 128 is chosen
    while(confirmLength <= 7 || confirmLength >= 128) {
      ...
      // What is needed in random password
      ...
      var confirmUpperCase = confirm("Click OK if you would like to include UPPERCASE characters");
        // Keep looping if nothing is chosen
     ...
     //Googled and found out you can join strings together by using concat   
  
     // "" will be filled with the random characters selected
    var randomPassword = ""
